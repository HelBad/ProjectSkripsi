...
import com.example.projectskripsi.features.pesanan.presentation.ActivityRiwayatUser
...
class FragmentPesananUser : Fragment() {
    ...
    private fun loadData() {
        ...
        btnSelesai.setOnClickListener {
            val query = databasePesanan.child("selesai").orderByChild("id_user")
                .equalTo(SP.getString("id_user", "").toString())
            listData(query)
        ...
        btnDibatalkan.setOnClickListener {
            val query = databasePesanan.child("dibatalkan").orderByChild("id_user")
                .equalTo(SP.getString("id_user", "").toString())
            listData(query)
            btnDiproses.backgroundTintList = ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
            btnSelesai.backgroundTintList = ColorStateList.valueOf(resources.getColor(R.color.colorPrimary))
            ...
            override fun onCreateViewHolder(parent:ViewGroup, viewType:Int): ViewholderPesanan {
                ...
                viewHolder.setOnClickListener(object: ViewholderPesanan.ClickListener {
                    override fun onItemClick(view:View, position:Int) {
                        val intent = Intent(view.context, ActivityRiwayatUser::class.java)
